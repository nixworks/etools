...
from partners.views.partner_organization_v2 import (
    ...
    PartnerNotAssuranceCompliant, PartnerNotSpotCheckCompliant, PartnerNotProgrammaticVisitCompliant,
    PartnerWithSpecialAuditCompleted, PartnerWithScheduledAuditCompleted)
